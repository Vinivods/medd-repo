...
# *RETORNAR VALIDADES
    with st.container():
        ...
        st.subheader("Insira seu email para pesquisar suas validades adicionadas")
        email_validade_pesquisar = st.text_input("Insira seu email para pesquisar")
        ...
        if botao_pesquisar:
            ...
            if resultados:
                ...
                def create_pdf(df):
                    ...
                    pdf_canvas.drawCentredString(300, 730, "Medicamentos que vão vencer em até 30 dias")
