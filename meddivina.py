...
if menu == "Bem-vindo":
    with st.container():
        ...
        st.markdown("<h5 style='text-align: center; margin: 0 0 2% 0'; font-family: Repo>Cadastre as validades dos medicamentos que você quer acompanhar e tenha acesso a elas diretamente pelo medD.</h5>", unsafe_allow_html=True)
            ...
            def add():
                ...
                try:
                    ...
                    try:
                        ...
                        # print(resultado_verificar_email)
